DATA_TABLE = [
  ...
  { ts: 170, as: 60, gs: 60, p: -10, r: 0, h: 300, sh: 300, a: 0, sa: 0, abp: 100.0, vsi: -3.0 },
  { ts: 171, as: 50, gs: 50, p: 2, r: 0, h: 300, sh: 300, a: 0, sa: 0, abp: 100.0, vsi: 0.0 },
  { ts: 180, as: 0, gs: 0, p: 5, r: 0, h: 300, sh: 300, a: 0, sa: 0, abp: 100.0, vsi: 0.0 }
]
...
setInterval ->
  ...
  avionics.groundSpeed = data.groundspeed
  avionics.selectedAltitude = data.selected_altitude
, 50
